...
<head>
	...
	<link rel="shortcut icon" href="<?php echo base_url().'assets/img/apotek.png' ?>"/>
	<title>Apotek</title>
...
<body>
<nav class="navbar navbar-expand-lg navbar-light fixed-top header-navbar nav">
		<a class="navbar-brand" href="home.html"><img class="navbar-img" src="<?php echo base_url().'assets/img/apotek.png' ?>" alt="apotek"> Apotek</a>
